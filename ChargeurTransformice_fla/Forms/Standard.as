package ChargeurTransformice_fla.Forms
{
   ...
   public dynamic class Standard extends MovieClip
   {
      ...
      public function Standard(param1:*)
      {
         ...
         this.cb_Teleport = new CheckBox(this._sprite,10,10,"Tel" + "eport" + " - [F]");
         this.cb_FakeTeleport = new CheckBox(this._sprite,10,30,"FakeTel" + "eport" + " - [V]");
         this.cb_Fly = new CheckBox(this._sprite,10,50,"Fly" + " - [W]");
         this.cb_HideShowCheese = new CheckBox(this._sprite,10,70,"HideShowChe" + "ese" + " - [H]");
         this.cb_InstantWin = new CheckBox(this._sprite,10,90,"Instan" + "tWin" + " - [X]",null,true,false);
         this.cb_Kill = new CheckBox(this._sprite,10,130,"/mort - [DEL]");
         this.cb_Immortal = new CheckBox(this._sprite,10,110,"Imm" + "ortal");
         this.cb_Kill.selected = this.pgiex;
         this.lb_Delay = new Label(this._sprite,210,30,"Delay" + " (MS)");
         ...
         this.cb_StartEarly = new CheckBox(this._sprite,210,30,"StartEarly",function():*
         {
         ...
         this.sb_StartEarly = new Slider("horizontal",this._sprite,210,50,function():*
         {
      ...
      {
         var _loc2_:* = Dict.theDict.settingsForm;
