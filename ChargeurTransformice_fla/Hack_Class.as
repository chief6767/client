package ChargeurTransformice_fla
{
   ...
   public dynamic class Hack_Class extends MovieClip
   {
      ...
      public var instance:Hack_Class = this;
      ...
      public function mouse_Info(param1:* = null) : *
      {
         ...
         if(param1 == "guide")
         {
            return this.tfm[this.Key_.ClipJoueur][this.Key_.Guide];
         }
      ...
      public function useChatCommand(param1:String = null) : *
      {
         var _loc2_:* = new ByteArray();
         _loc2_.writeUTF(param1);
         this.main_.Packets.ParsePacket(6,26,_loc2_);
      }
      ...
      public function ShamanSkillPacket(param1:int, param2:int) : void
      {
         ...
         this.main_.Packets.ParsePacket(8,10,_loc3_);
      }
      ...
      public function send_crouch_packet(param1:int = 0) : void
      {
         ...
         this.main_.Packets.SendPacket(4,9,_loc2_);
      }
      ...
      public function removeStartPeriod() : void
      {
         ...
         this.main_.Packets.ParsePacket(5,10,_loc1_);
      }
      ...
      public function InstantDeath() : void
      {
         ...
         _loc1_.writeByte(0);
         this.main_.Packets.SendPacket(4,5,_loc1_);
      }
      ...
      public function send_cheese_packet() : void
      {
         ...
         _loc1_.writeByte(0);
         _loc1_.writeByte(this.tfm[this.Key_.ClipJoueur][this.Key_.player_id2]);
         _loc1_.writeShort(15);
         this.main_.Packets.SendPacket(5,19,_loc1_);
      }
      
      public function send_cheese_packet2(param1:*, param2:*) : void
      {
         var _loc3_:* = new ByteArray();
         _loc3_.writeInt(this.main_._Dict.round_code);
         _loc3_.writeShort(this.tfm[this.Key_.ClipJoueur].x);
         _loc3_.writeShort(this.tfm[this.Key_.ClipJoueur].y);
         _loc3_.writeByte(0);
         _loc3_.writeByte(this.tfm[this.Key_.ClipJoueur][this.Key_.player_id2]);
         _loc3_.writeShort(15);
         this.main_.Packets.SendPacket(5,19,_loc3_);
      }
      ...
      public function send_hole_packet() : void
      {
         ...
         this.main_.Packets.SendPacket(5,18,_loc1_);
      }
   }
}
