package coms.bit101.components
{
   ...
   public class Style
   {
      ...
      public static function initialisationStyle() : void
      {
         ...
         GLOBAL_STYLESHEET.setStyle("PR",{"color":"#16dbff"});
         GLOBAL_STYLESHEET.setStyle("button",{
            "padding":"10px 20px",
            "font-size":"16px",
            "cursor":"pointer"
         });
         GLOBAL_STYLESHEET.setStyle("username",{
            "color":"#FFFFFF",
            "fontWeight":"bold",
            "display":"inline",
            "letterSpacing":"0"
         });
         GLOBAL_STYLESHEET.setStyle("message",{
            "color":"#D3D3D3",
            "fontWeight":"bold",
            "display":"inline",
            "letterSpacing":"0",
         ...
         GLOBAL_STYLESHEET.setStyle("img",{
            "display":"inline",
